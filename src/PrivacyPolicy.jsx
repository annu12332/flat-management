            ...
            <div className="bg-[#1B2D4F] py-12 px-6 text-center">
                <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-slate-400">
                        How RentBook flow collects, uses, and protects your information.
                    </p>
            ...
            <div className="max-w-3xl mx-auto px-4 py-10">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 text-sm leading-relaxed text-gray-700">
                    <p className="mb-6 text-gray-600">
                        Jabed International ("we", "us", "our") operates the RentBook flow rental
                        ...
                        have. By using RentBook flow, you agree to the collection and use of
                    ...
                    <Section number={2} title="How We Use Your Information">
                        <ul className="list-disc list-inside space-y-1 text-gray-600">
                            <li>To create and manage your RentBook flow account and subscription.</li>
                    ...
                    <Section number={8} title="Children's Privacy">
                        <p className="text-gray-600">
                            RentBook flow is intended for use by adults managing rental properties. We do
                    ...
                    <Section number={9} title="Changes to This Policy">
                        <p className="text-gray-600">
                            ...
                            be communicated via in-app notification or email. Continued use of RentBook flow after changes take effect constitutes acceptance of the revised
                            policy.
                        </p>
                    </Section>
                    ...
                    <Section number={10} title="Contact Us">
                        <p className="text-gray-600">
                            ...
                            handled, please contact Jabed International through the official RentBook flow channels provided in the app.
                        </p>
                    </Section>
