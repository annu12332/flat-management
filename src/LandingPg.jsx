...
function StepItem({ number, title, desc }) {
    return (
        <div className="flex gap-6 items-start group">
            <div className="w-10 h-10 rounded-full bg-[#1B2D4F] text-white font-bold flex items-center justify-center text-[15px] flex-shrink-0 transition-transform duration-300 group-hover:scale-110 group-hover:bg-[#E91E63]">
                {number}
            </div>
            <div className="pt-1">
    ...
    return (
        <div className="font-['Inter',sans-serif] text-[#1B2D4F] bg-[#f4f6fa]">
            ...
            <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 py-4 px-6" style={{ animation: "fadeInUp 0.6s cubic-bezier(0.16,1,0.3,1) both" }}>
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-lg text-[#1B2D4F]">RentBook</span>
                    </div>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#111E35] via-[#1B2D4F] to-[#243a5e] py-16 md:py-24">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_50%,rgba(233,30,99,0.15)_0%,transparent_60%)] animate-pulse-glow" />
                <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative">
                    {/* Content */}
                    <div>
                        <div
                            className="inline-flex items-center gap-1.5 bg-[#E91E63]/15 border border-[#E91E63]/30 text-[#f48fb1] px-3.5 py-1.5 rounded-full text-[13px] font-medium mb-6"
                        ...
                        >
                            Rent Book is the all-in-one rental management app built for Bangladeshi
                        ...
                        >
                            <Link
                                to="/subscribe"
                                className="btn-pop bg-[#E91E63] hover:bg-[#c2185b] text-white py-3.5 px-8 rounded-xl font-semibold text-[15px] inline-flex items-center gap-2 transition"
                            >
                                Choose a Plan →
                            </Link>
                            <a
...
>
    ...
    <div className="hidden md:flex absolute -bottom-3 -left-4 z-10 items-center gap-1.5 bg-white rounded-xl border border-pink-200 shadow-lg px-2.5 py-1.5 animate-float-slow">
    ...
    {/* Pill badge */}
    <div className="hidden md:block absolute top-4 -left-2 z-10 bg-[#E91E63] text-white text-[9px] font-semibold px-3 py-1 rounded-full shadow-lg animate-float-slow">
        Starts at ৳500
    </div>
        ...
        <div className="p-2 bg-gray-100 space-y-1.5">
            ...
            <div className="bg-white rounded-lg p-2 border border-slate-200">
                ...
                <div className="flex items-end gap-1 h-7">
                    ...
                    <div className="flex-1 rounded-t bg-[#E91E63] bar-grow" style={{ height: '25%', animationDelay: '0.3s' }}></div>
                    ...
                    <div className="flex-1 rounded-t bg-[#E91E63] bar-grow" style={{ height: '95%', animationDelay: '0.6s' }}></div>
                </div>
            </div>
                    ...
                    <div className="space-y-8">
                        <Reveal delay={0}>
                            <StepItem
                                ...
                                desc="Get Rent Book from the Play Store. Pick a plan, pay via bKash or Nagad, and your account is activated within 24 hours."
                            />
                        </Reveal>
                        <Reveal delay={100}>
                            <StepItem
            ...
            <section id="download" className="py-20 px-6 bg-[#1B2D4F] relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_50%,rgba(233,30,99,0.12)_0%,transparent_60%)] animate-pulse-glow" />
                    ...
                    <Reveal delay={150} className="flex justify-center">
                        <div className="bg-white rounded-3xl p-6 shadow-[0_32px_80px_rgba(0,0,0,0.35)] w-64 animate-float-slow">
                            ...
                            <div className="text-center mt-4">
                                ...
                                <div className="text-xs text-slate-400 mt-1">Rent Book • Android App</div>
                            </div>
                        </div>
                    </Reveal>
                </div>
        ...
        <Reveal>
                ...
                <div className="max-w-3xl mx-auto">
                    <Reveal>
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            <div className="card-rise flex items-center gap-3 px-8 py-5 rounded-2xl border-2 font-bold text-lg border-[#E91E63] text-[#E91E63] bg-[#fff0f3] hover:-translate-y-1">
                                <span className="text-2xl">💳</span> bKash
                            </div>
                            <div className="card-rise flex items-center gap-3 px-8 py-5 rounded-2xl border-2 font-bold text-lg border-[#F97316] text-[#F97316] bg-[#fff7ed] hover:-translate-y-1">
            ...
            <section className="py-20 px-6 text-center relative overflow-hidden bg-gradient-to-br from-[#111E35] via-[#1B2D4F] to-[#243a5e]">
                ...
                <Reveal className="max-w-2xl mx-auto relative">
                    ...
                    <Link
                        to="/subscribe"
                        className="btn-pop bg-[#E91E63] hover:bg-[#c2185b] text-white text-lg px-10 py-4 rounded-xl font-semibold inline-flex items-center gap-2 transition"
                    >
            ...
            <footer className="py-10 px-6 bg-[#111E35] text-slate-400">
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div>
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <span className="font-bold text-white">Rent Book</span>
                            </div>
                    ...
                    <div className="border-t border-white/[0.08] pt-6 text-center text-sm">
                        © 2026 Rent Book by Jabed International. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
